	...
	def mavenHome
        ...
        stage('Code Analysis') {
                ...
                withSonarQubeEnv('Sonar7.1') {
                        bat "${scannerHome}/bin/sonar-scanner -Dsonar.host.url=http://localhost:9000 -Dsonar.login=e7a265e30e43766417d77b2f371a77231a6704d7 -Dsonar.projectVersion=1.0 -Dsonar.projectKey=PetClinic_Key -Dsonar.sources=src -Dsonar.java.binaries=."
                }
        } 
	stage('Build') {
